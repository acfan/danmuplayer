...
///////
	...
	function src(src){
		...
		var sendStyle=$( "<p>高速<input type=radio name=style value=2>悬停<input type=radio name=style value=1>普通<input type=radio checked=checked name=style value=0 ></p> ");
